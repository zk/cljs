...
(function() {
  ...
  this.str = (function(){
    ...
    }.bind(this)), "", this.filter((function(p1__3261_HASH_){
      return this._["identity"](p1__3261_HASH_);
    }.bind(this)), args));
  }.bind(this));
  ...
  this.assoc = (function(obj){
    ...
    return (function(){
      ...
      (function() {
        var G__3263 = pairs;
        for(var i=0; i < G__3263.length; i++) {
          (function(p){(obj[this.first(p)] = this.nth(p, 1))}.bind(this))(G__3263[i]);
        }
      }.bind(this))();
  ...
  this.conj = (function(col){
    ...
    (function() {
      var G__3264 = rest;
      for(var i=0; i < G__3264.length; i++) {
        (function(r){col["push"](r)}.bind(this))(G__3264[i]);
      }
    }.bind(this))();
    return col;
  }.bind(this));
  ...
  this.merge = (function(){
    ...
    return (function(){
      ...
      this.map((function(p1__3262_HASH_){
        return this._["extend"](o,p1__3262_HASH_);
      }.bind(this)), objs);
...
}).call(cljs.core);var common = common || {};
(function() {
...
(function() {
  ...
  for(var prop in lib.one){ this[prop] = lib.one[prop] };
